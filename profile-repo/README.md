...
| --- | --- | --- |
| **Proofhouse** | Flagship PromptOps v1.3 — clarify → compile → self-heal with Sept 2026 frontier model profiles; offline eval harness; Cursor skill | [repo](https://github.com/KM-it-ops/Proofhouse) |
...
- **Proofhouse** — public flagship PromptOps framework with model-specific compile loop and offline evals
