...
(function () {
  ...
  function initTerminal() {
    ...
    const BANNER = [
      '',
      'Welcome to michael@al-kurdi — portfolio shell (bash-ish).',
    ...
    function writeCmd(cmd) {
      const html =
        '<span class="iterm-line">' +
          ...
          '<span class="term-host">al-kurdi</span>' +
    ...
    function about() {
      write(
        '<div><span class="iterm-ok">Mahmoud "Michael" Al Kurdi</span> — SOC / Cybersecurity Analyst (targeting).</div>' +
    ...
    function run(raw) {
      ...
      switch (cmd) {
        ...
        case 'whoami':   write('<div class="iterm-ok">Mahmoud ("Michael") Al Kurdi</div>'); break;
        case 'uname':    write('<div class="iterm-muted">Portfolio 1.0.0 michael@al-kurdi static-html #1 ' + new Date().toUTCString() + '</div>'); break;
